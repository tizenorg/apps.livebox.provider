 ...
 */
extern struct livebox_buffer *provider_buffer_acquire(enum target_type type, const char *pkgname, const char *id, int width, int height, int pixel_size, int (*handler)(struct livebox_buffer *, enum buffer_event, double, double, double, void *), void *data);

/*!
 */
extern struct livebox_buffer *provider_buffer_create(enum target_type type, const char *pkgname, const char *id, int (*handler)(struct livebox_buffer *, struct buffer_event_data *, void *), void *data);

/*!
 */
extern int provider_buffer_acquire_NEW(struct livebox_buffer *info, int width, int height, int pixel_size);
...
/*!
 */
extern int provider_buffer_release_NEW(struct livebox_buffer *info);
/*!
 */
